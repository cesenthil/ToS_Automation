...
from Wait_Time import Four_PM_Check
...
def Tos_EM_Capture():
    ...
    Four_PM_Check() #Wait till the time is 04:00 PM for the day

    Email_Message = ""

    for i in range(0,6,1): #Range(start,end,increment)
        ...
        Email_Message = Email_Message + Opt_Expiry_Name.text + " | " + Opt_Expiry_EM.text + " @ " + Time_Stamp.__str__() + '\n'
        sleep(10)
